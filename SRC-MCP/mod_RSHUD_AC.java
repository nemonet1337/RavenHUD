...
/*
    ...
    public static int ColorInt_Normal;
    public static int ColorInt_Warning;
    public static int ColorInt_Alert;
    public static int ColorInt_Number;

    public static int ColorInt_Iron;
    public static int ColorInt_Gold;
    public static int ColorInt_Diamond;
    public static int ColorInt_Lava;
*/

    public static KeyBinding guiKey;
    @MLProp(info="Line Color (AARRGGBB):Default c7ffae00")
    public static String Color_Normal = "c7ffae00";
    @MLProp(info="Warning Color(AARRGGBB):Default e5ffff00")
    public static String Color_Warning = "e5ffff00";
    @MLProp(info="Alert Color(AARRGGBB):Default e5ff0000")
    public static String Color_Alert = "e5ff0000";
    @MLProp(info="Number Color(AARRGGBB):Default ccd09000")
	...
	public void ModsLoaded() {
		...
		try {
			...
			GuiRSHUD_AC rshud = new GuiRSHUD_AC(this);
